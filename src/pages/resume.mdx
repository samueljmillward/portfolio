...
Graduated from Manchester Codes’ Software Engineer FastTrack Course. Me and my cohort were taught the fundamentals of Web Development (MERN Stack) by current full-time developers.
...
Most recently I have been focusing on frontend topics such as; React Native, performance, browser support as well as Static Site Generators such as Gatsby.
